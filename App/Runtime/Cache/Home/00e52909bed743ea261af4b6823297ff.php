...
<p>2.将文件App/Common/Conf/config_bak.php 重命名为config.php文件</p>

<p>3.在config.php文件填写数据库配置信息</p>

<p>后台地址：<a href="<?php echo U('admin/login/index');?>">进入后台管理系统</a>   账号admin  密码 admin</p>

<p><strong>=============================相关信息====================================</strong></p>

<p><strong>演示地址</strong>：<a href="http://demo.www.bobolucy.com/index.php/admin/">http://demo.www.bobolucy.com/index.php/admin/</a>  账号admin  密码 admin</p>

<p><strong>官网地址</strong>：<a href="http://www.bobolucy.com/">http://www.bobolucy.com/</a></p>
