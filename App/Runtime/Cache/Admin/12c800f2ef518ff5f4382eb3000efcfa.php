                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="<?php echo U('update');?>" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                    <?php if($member['uid'] == 1): ?>readonly class="rcol-xs-10 col-sm-5" value="<?php echo ($member["user"]); ?>">
                                        <?php else: ?>
                                        name="phone" class="rcol-xs-10 col-sm-5" value="<?php echo ($member["phone"]); ?>"><?php endif; ?>
        ...
        <div class="footer-inner">
            ...
            <div class="footer-content">
                            <span class="bigger-120">
                                <small>Copyright &copy; 2015 <a href="http://www.bobolucy.com" target="_blank">波波</a> All Rights Reserved.</small>
                            </span>
            </div>
